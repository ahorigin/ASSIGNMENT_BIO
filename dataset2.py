...
def cross_over(parents, type = None):
    ...
    if type == 1: # single point cross over
        ...
        # p1 = population[0]
        # p2 = population[1]
        cr_point_1 = random.randint(1, 64)
        cr_point_2 = random.randint(1, 64)
        while True:
...
# this section of code is used for testing purpose of inital populations performancepop = []
# for i in range(5):
#     ind = []
#     for j in range(25):
...
train, test = util.split_into_train_test(df, 0.7)
...
for l  in range(NUM_GENERATION):
    ...
    while len(pop) < NUM_OF_INDI:
        ...
        # cross_point = random.randint(0,448)
